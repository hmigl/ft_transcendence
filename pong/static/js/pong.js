...
// função para esperar a DOM ser carregada antes de chamar a função setup()
// senão o script do pong tenta acessar elementos da página antes de eles serem inseridos na DOM
